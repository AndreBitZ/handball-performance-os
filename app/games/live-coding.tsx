...
const actions: { key: LiveCodingAction; label: string }[] = [
  ...
  { key: 'TURNOVER', label: '↩️ Perda' }, { key: 'STEAL', label: '🔄 Recuperação' }, { key: 'ASSIST', label: '🅰️ Assistência' },
  { key: 'SUSPENSION_2M', label: '2️⃣ 2 min' }, { key: 'SEVEN_METER', label: '7️⃣ 7 metros' }, { key: 'FOUL', label: '🚫 Falta' },
  { key: 'YELLOW', label: '🟨 Amarelo' }, { key: 'RED', label: '🟥 Vermelho' },
]

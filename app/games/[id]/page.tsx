...
import { downloadMatchPackage } from '../../../src/lib/integration/matchPackageFile'
...
export default function GameDetailPage({ params }: { params: { id: string } }) {
  ...
  async function exportForStats() {
    ...
    try { await downloadMatchPackage(currentMatch.id); setMessage('Match JSON criado. Importa este ficheiro no Andebol-Stats.') }
    catch (error) { setMessage(error instanceof Error ? error.message : 'Não foi possível criar o Match JSON.') }
